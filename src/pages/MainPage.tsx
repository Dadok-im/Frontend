    ...
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-[#4A5D73] via-[#5C6373] to-[#A3B8C6] text-[#F5F7FA]">
      ...
      <header className="relative z-10 border-b border-[rgba(163,184,198,0.25)] bg-[rgba(245,247,250,0.12)] backdrop-blur-2xl shadow-lg">
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-4 px-4 py-5 sm:px-6 md:flex-row md:items-center md:justify-between">
          <Link
            className="text-center text-2xl font-bold tracking-tight text-transparent sm:text-3xl md:text-left md:text-[2rem] bg-gradient-to-r from-[#F5F7FA] to-[#A3B8C6] bg-clip-text drop-shadow-lg"
            to={ROUTES.HOME}
          >
            다독임 - 심리 상담 서비스
          </Link>
      ...
      <main className="relative z-10 mx-auto w-full max-w-6xl px-4 pb-16 sm:px-6 md:pb-24">
        ...
        <section className="py-16 text-center sm:py-20 md:py-24">
          <h1 className="text-3xl font-bold tracking-tight text-transparent drop-shadow-xl sm:text-4xl md:text-5xl bg-gradient-to-r from-[#F5F7FA] to-[#A3B8C6] bg-clip-text">
          ...
          <div className="mt-10 rounded-3xl border border-[rgba(163,184,198,0.35)] bg-[rgba(245,247,250,0.2)] p-8 text-base leading-relaxed backdrop-blur-2xl shadow-2xl sm:p-12 sm:text-lg md:mt-12 md:p-16 text-[#1E1E1E]">
            배너 / 소개 이미지
          </div>
        </section>
        ...
        <section className="py-14 sm:py-16 md:py-20">
          <h2 className="text-center text-2xl font-bold tracking-tight text-transparent drop-shadow-xl sm:text-3xl md:text-4xl bg-gradient-to-r from-[#F5F7FA] to-[#A3B8C6] bg-clip-text">
            이용 가능한 서비스
          </h2>
          ...
          <div className="mt-10 grid gap-6 sm:mt-12 sm:grid-cols-2 sm:gap-8 lg:grid-cols-3">
            ...
            >
              ...
              <strong className="text-lg font-semibold text-[#F5F7FA] sm:text-xl">AI 상담 시작하기</strong>
            ...
            >
              ...
              <strong className="text-lg font-semibold text-[#F5F7FA] sm:text-xl">주변 병원 검색</strong>
              <p className="mt-2 text-sm text-[#F5F7FA]/80 sm:mt-3">
            ...
            >
              ...
              <strong className="text-lg font-semibold text-[#F5F7FA] sm:text-xl">캘린더</strong>
              <p className="mt-2 text-sm text-[#F5F7FA]/80 sm:mt-3">
                약물 캘린더 확인하기
              </p>
            </Link>
